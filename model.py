...
from transformers.models.chinese_clip.modeling_chinese_clip import ChineseCLIPVisionTransformer
from timm.models.layers import DropPath
import torch.utils.checkpoint as cp

from ms_deform_attn import MSDeformAttnFunction
...
class ChineseCLIPViTAdapterModel(ChineseCLIPVisionTransformer):
    def __init__(self, pretrain_size=224, num_heads=12, conv_inplane=64, n_points=4, deform_num_heads=6,
                 ...
                 deform_ratio=1.0, add_vit_feature=True, use_extra_extractor=True, config=None, *args, **kwargs):
        super(ChineseCLIPViTAdapterModel, self).__init__(config)

        self.spm = SpatialPriorModule(inplanes=conv_inplane, embed_dim=config.hidden_size)
